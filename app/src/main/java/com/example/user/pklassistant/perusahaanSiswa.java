...
public class perusahaanSiswa implements Serializable {
    ...
    public perusahaanSiswa( String nama, String alamat, String telp, String ket, String maps) {
        namaPerusahaan = nama;
